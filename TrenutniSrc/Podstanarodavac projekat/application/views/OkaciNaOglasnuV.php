<html>
	...
	<body>
		<header>
			<h1 align="center">
                            <img src="<?= base_url() ?> public/images/logo.png" alt="Logo" style="width:200px;"></h1>
		</header>
		...
		<br><br><br>
		 ...
		 <table align='center' width='40%' bgcolor='black'>
			...
			<tr height="350px">
				<td colspan='2' bgcolor='white' align='center' width='50%'>
					...
					<br/>
                                        <form name='okaciNaOglasnuTablu' action="<?php 
                                        echo site_url('Stanodavac/okaciNaOglasnuV')?>" method="POST" >
						<table>
		 ...
		 <hr>
			<footer>
				<p><i>Copyright 2019, Kakav tim - Strašan tim,
