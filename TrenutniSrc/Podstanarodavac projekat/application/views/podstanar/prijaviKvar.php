		  ...
		  <div class="collapse navbar-collapse" id="navbarResponsive">
			...
			<tr height="350px">
                            <td colspan='2' bgcolor='white' align='center' width='50%'>
                                <div class="card-body">  
                                    <h5 class="card-title text-center"> Prijavite kvar </h5><hr><br>
                                    <form class="form" name="prijaviKvar" action="<?php echo site_url('Podstanar/prijaviKvar') ?>" method="post">

                                        <input type="text" name="naslovKvara" class="form-control" placeholder="Naslov" value="<?php echo set_value('naslovKvara') ?>"> <br>
                                        <input type="text" name="opisKvara" class="form-control" placeholder="Tekst" value="<?php echo set_value('opisKvara') ?>"> <br>
                                        <br>
                                        <input class="btn btn-md btn-success btn-block text-uppercase" type="submit"  name="tip" value="Prijavi">
